...
select matches(waldo.owner_for_auth('00000000-0000-0000-0000-0000000000d2', 'clone@test.invalid', pg_temp.at(), pg_temp.sig('owner.00000000-0000-0000-0000-0000000000d2.clone@test.invalid')), '^owner-', 'email-only signup creates an owner');
select is((select phone from waldo.owners where email = 'clone@test.invalid'), null, 'phone stays null when not collected');
