...
select is(waldo.signin_allowed('stranger@test.invalid', pg_temp.at(), pg_temp.sig('signin.stranger@test.invalid')), false, 'a stranger may not');
...
select is(waldo.owner_for_auth('00000000-0000-0000-0000-0000000000c3', 'stranger@test.invalid', pg_temp.at(), pg_temp.sig('owner.00000000-0000-0000-0000-0000000000c3.stranger@test.invalid')), null, 'a stranger gets no owner');
