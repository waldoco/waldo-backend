<!-- MIRRORED FROM waldo-brain/.claude/rules/language.md @ 8f74f163fdb0 -->
<!-- Do not edit locally. Edit canonical in waldo-brain, then resync. -->
<!-- Sync ritual: see waldo-brain/.claude/rules/MIRROR-SYNC.md -->

# Architecture Language

> **Canonical source:** `waldo-brain/.claude/rules/language.md` @ `8f74f163fdb0`. This file is a verbatim mirror per [[0063-canonical-rule-files-mirroring|ADR-0063]]. Edits land canonical-first; do not edit locally.
