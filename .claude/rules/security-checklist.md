<!-- MIRRORED FROM waldo-brain/.claude/rules/security-checklist.md @ 833eb449309e -->
...
> **Canonical source:** `waldo-brain/.claude/rules/security-checklist.md` @ `833eb449309e`. This file is a verbatim mirror per [[0063-canonical-rule-files-mirroring|ADR-0063]]. Edits land canonical-first; do not edit locally.
