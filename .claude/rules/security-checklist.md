<!-- MIRRORED FROM waldo-brain/.claude/rules/security-checklist.md @ 8f74f163fdb0 -->
...
> **Canonical source:** `waldo-brain/.claude/rules/security-checklist.md` @ `8f74f163fdb0`. This file is a verbatim mirror per [[0063-canonical-rule-files-mirroring|ADR-0063]]. Edits land canonical-first; do not edit locally.
