...
When exploring the codebase, use `Docs/CONTEXT.md` for the domain vocabulary, and check `.claude/rules/architecture.md` for the 11 locked decisions in the area you're touching.
