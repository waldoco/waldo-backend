...
export type TurnLogEntry = Readonly<{ trace: string; hop: string; owner?: string; ms: number; ok: boolean; error?: string; detail?: string; code?: string; usage?: ModelUsage; shape?: Readonly<{ system_bytes: number; request_bytes: number }>; text?: TurnText }>;
