...
const responsibilityEffectRejectionCasesV04Schema = z
  .array(
    z.strictObject({
  ...
  const files: Record<string, string> = {
    ...
    'responsibility-effect.rejections.json': file(
      responsibilityEffectRejectionCatalogueV04Schema.parse({
        ...
        cases: [
          {
            name: 'intent-credential-field',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, credential: 'secret' },
          },
          {
            name: 'intent-oauth-token-field',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, oauthToken: 'secret' },
          },
          {
            name: 'intent-mcp-field',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, mcpServer: 'ambient' },
          },
          {
            name: 'intent-provider-done-field',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, providerDone: true },
          },
          {
            name: 'intent-evidence-field',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, evidence: { id: 'evidence_attacker' } },
          },
          {
            name: 'intent-acceptance-field',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, acceptance: 'accepted' },
          },
          {
            name: 'intent-closure-field',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, closure: 'closed' },
          },
          {
            name: 'intent-invalid-revision',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, revision: 2 },
          },
          {
            name: 'intent-invalid-use-index',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, authority: { ...effectIntent.authority, useIndex: 2 } },
          },
          {
            name: 'intent-non-frozen-state',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, state: 'issued' },
          },
          {
            name: 'intent-expiry-before-freeze',
            schema: 'effect-intent.schema.json',
            layer: 'runtime',
            zodOutcome: 'reject',
            value: { ...effectIntent, expiresAt: effectIntent.frozenAt },
          },
          {
            name: 'intent-malformed-argument-digest',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, argumentDigest: 'sha256:not-a-digest' },
          },
          {
            name: 'intent-lone-surrogate-id',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, id: '\ud800' },
          },
          {
            name: 'intent-id-byte-ceiling',
            schema: 'effect-intent.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectIntent, id: `effect_${'a'.repeat(128)}` },
          },
          {
            ...
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...effectIntent, intentDigest: `sha256:${'f'.repeat(64)}` },
          },
          {
            name: 'receipt-raw-response-field',
            schema: 'effect-receipt.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectReceipt, rawResponse: { private: true } },
          },
          {
            name: 'receipt-provider-done-field',
            schema: 'effect-receipt.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectReceipt, providerDone: true },
          },
          {
            name: 'receipt-artifact-field',
            schema: 'effect-receipt.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectReceipt, artifact: { id: 'artifact_attacker' } },
          },
          {
            name: 'receipt-acceptance-field',
            schema: 'effect-receipt.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectReceipt, acceptance: 'accepted' },
          },
          {
            name: 'receipt-third-attempt',
            schema: 'effect-receipt.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...effectReceipt, attempt: 3 },
          },
          {
            name: 'receipt-applied-without-external-ref',
            schema: 'effect-receipt.schema.json',
            layer: 'runtime',
            zodOutcome: 'reject',
            value: { ...effectReceipt, externalEffectRef: null },
          },
          {
            name: 'receipt-observation-before-issue',
            schema: 'effect-receipt.schema.json',
            layer: 'runtime',
            zodOutcome: 'reject',
            value: { ...effectReceipt, observedAt: '2026-08-08T18:11:00.999Z' },
          },
          {
            name: 'receipt-issued-before-frozen-intent',
            schema: 'effect-receipt.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...effectReceipt, issuedAt: '2026-08-08T18:10:59.999Z' },
          },
          {
            name: 'receipt-owner-mismatch',
            schema: 'effect-receipt.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...effectReceipt, ownerId: 'owner_other' },
          },
          {
            name: 'receipt-intent-digest-mismatch',
            schema: 'effect-receipt.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...effectReceipt, intentDigest: `sha256:${'a'.repeat(64)}` },
          },
          {
            name: 'receipt-reconciliation-key-mismatch',
            schema: 'effect-receipt.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...effectReceipt, reconciliationKey: 'effect_reconciliation_other' },
          },
          {
            name: 'receipt-adapter-mismatch',
            schema: 'effect-receipt.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: {
              ...effectReceipt,
              adapter: { ...effectReceipt.adapter, id: 'effect_adapter_other' },
            },
          },
          {
            name: 'reconciliation-provider-retry-field',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...terminalAmbiguity, providerRetry: true },
          },
          {
            name: 'reconciliation-provider-done-field',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...applied, providerDone: true },
          },
          {
            name: 'reconciliation-artifact-field',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...applied, artifact: { id: 'artifact_attacker' } },
          },
          {
            name: 'reconciliation-acceptance-field',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...applied, acceptance: 'accepted' },
          },
          {
            name: 'reconciliation-unavailable-as-not-applied',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...unavailable, state: 'authoritative_not_applied' },
          },
          {
            name: 'reconciliation-retry-unavailable-basis-kind',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...retry, basis: { ...retry.basis, kind: 'unavailable' } },
          },
          {
          ...
          {
            name: 'reconciliation-unknown-as-not-applied',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...unknown, state: 'authoritative_not_applied' },
          },
          {
            name: 'reconciliation-unknown-effect-retry',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...retry, basis: { ...retry.basis, kind: 'unknown' } },
          },
          {
            name: 'reconciliation-provider-retry-owner',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...retry, retryOwner: 'provider' },
          },
          {
            name: 'reconciliation-third-effect-retry',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: { ...retry, nextAttempt: 3 },
          },
          {
            name: 'terminal-ambiguity-not-applied-basis',
            schema: 'effect-reconciliation.schema.json',
            layer: 'schema',
            zodOutcome: 'reject',
            value: {
              ...terminalAmbiguity,
              basis: { ...terminalAmbiguity.basis, kind: 'authoritative_not_applied' },
            },
          },
          {
          ...
          {
            name: 'reconciliation-owner-mismatch',
            schema: 'effect-reconciliation.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...applied, ownerId: 'owner_other' },
          },
          {
            name: 'reconciliation-intent-digest-mismatch',
            schema: 'effect-reconciliation.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...applied, intentDigest: `sha256:${'b'.repeat(64)}` },
          },
          {
            name: 'reconciliation-key-mismatch',
            schema: 'effect-reconciliation.schema.json',
            layer: 'binding',
            zodOutcome: 'accept',
            value: { ...applied, reconciliationKey: 'effect_reconciliation_other' },
          },
        ],
      }),
    ),
