...
- active #88 boundary: one authenticated public command must bind a canonical WorkUnit revision and authority ceiling to the #80 writer and #87 boundary without exposing caller-supplied owner, provider, environment, context, operation-intent, or Durable Object authority;
...
4. prove one owner-authenticated public WorkUnit path through #80 and #87 with exact canonical revision/authority/binding, duplicate/replay/restart/cancel/expiry/stale-result/cross-owner falsifiers, external I/O outside transactions, and no implied product closure;
