...
| B4 judgment and authority | exact grant, revision/digest binding, expiry/revocation, atomic consume | local module behavior is green but independent review rejected `6416f74`; repair must make current-state/CAS proof non-vacuous and couple grant use structurally to B5 intent creation |
