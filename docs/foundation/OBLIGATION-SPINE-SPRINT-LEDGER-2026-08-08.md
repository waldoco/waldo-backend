...
| effect runtime | B5 fake-backed EffectEngine | `codex/obligation-effect-runtime` | `/Users/shivanshfulper/.codex/worktrees/osp-effect-runtime/waldo-backend` | `6b76fc3` | new EffectEngine and focused test only; no schema or wiring | first breaker rejected exact admission tuple, persisted-intent digest, unknown read-back, and terminal restart proof; repair active | rejected local `e9bc032`; no PR |
