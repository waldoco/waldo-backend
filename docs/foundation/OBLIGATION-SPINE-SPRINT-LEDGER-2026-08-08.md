...
| effect runtime | B5 fake-backed EffectEngine | `codex/obligation-effect-runtime` | `/Users/shivanshfulper/.codex/worktrees/osp-effect-runtime/waldo-backend` | `6b76fc3` | new EffectEngine and focused test only; no schema or wiring | repaired admission/recovery proof and security scan clear at `2b59f13`; one exact-expiry fixture remains vacuous and is under test-only repair | local `2b59f13`; no PR |
...
| B5 effects | frozen intent before I/O, single retry owner, reconcile-before-retry, terminal ambiguity | Effect contract published at `6b76fc3` after independent retry-laundering, exact retry-kind, digest-omission, and permissiveness mutations; runtime module and integration remain blocked on their own proof and the B4 atomic seam |
