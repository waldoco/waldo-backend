...
| contracts | #81 protocol v0.4 vertical slices | `codex/obligation-contracts` | `/Users/shivanshfulper/.codex/worktrees/osp-contracts/waldo-backend` | stacked on `12a014a` | `packages/contracts/**` plus its generator/guard registration | Judgment/Authority and Effect contract families published and independently review-clear; obligation-context acceptance-criteria binding is the active serial slice | published dependency `6b76fc3`; draft PR [#103](https://github.com/Pin4sf/waldo-backend/pull/103) |
