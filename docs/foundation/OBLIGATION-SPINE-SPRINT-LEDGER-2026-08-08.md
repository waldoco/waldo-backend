...
| effect runtime | B5 fake-backed EffectEngine | `codex/obligation-effect-runtime` | `/Users/shivanshfulper/.codex/worktrees/osp-effect-runtime/waldo-backend` | `6b76fc3` | new EffectEngine and focused test only; no schema or wiring | active; fake-backed module proof only | base `6b76fc3`; no PR |
